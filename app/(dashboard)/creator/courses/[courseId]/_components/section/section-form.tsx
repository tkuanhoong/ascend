...
import { createContext, SetStateAction, useState, useTransition } from "react";
...
export const ShowingConfirmModalContext = createContext<{
  isShowingConfirmModal: boolean;
  setIsShowingConfirmModal: React.Dispatch<SetStateAction<boolean>>;
}>({
...
export const SectionForm = ({ initialData, courseId }: SectionFormProps) => {
  ...
  const isShowingConfirmModalContextValue = {
    ...
    <div className="relative mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isCreating && (
        ...
        >
          ...
          <ShowingConfirmModalContext.Provider
            value={isShowingConfirmModalContextValue}
          >
            <SectionList
              onReorder={onReorder}
